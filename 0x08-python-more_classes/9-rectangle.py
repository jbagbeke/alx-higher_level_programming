...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Args 1: rect_1(First area of rect)
        Args 2: rect_2(Second aread of rect)
        """
    ...
    def square(cls, size=0):
        ...
        Args 1: cls(Object to be instantiated)
        Args 2: size(Value to initialise with variables)
        """
        my_class = cls(size, size)
        return my_class
